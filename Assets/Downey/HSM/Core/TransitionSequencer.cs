...
namespace Downey.HSM
{
    ...
    public class TransitionSequencer
    {
        ...
        //Request a transition from one to another
        public void RequestTransition(State from, State to)
        {
            //Machine.ChangeState(from, to);
            if(to == null || from == to) return;
            if(_sequencer != null){pending = (from, to); return;}
        ...
        void BeginTransition(State from, State to)
        {
            ...
            //_sequencer = new SequentialPhase(exitSteps, cts.Token);
        ...
        public void Tick(float deltaTime)
        {
            if (_sequencer != null)
            {
                ...
                return; // While translationing, we dont run normal updates
            }
